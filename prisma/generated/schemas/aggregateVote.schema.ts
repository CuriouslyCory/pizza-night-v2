...
export const VoteAggregateSchema = z.object({ orderBy: z.union([VoteOrderByWithRelationInputObjectSchema, VoteOrderByWithRelationInputObjectSchema.array()]).optional(), where: VoteWhereInputObjectSchema.optional(), cursor: VoteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), _count: z.union([ z.literal(true), VoteCountAggregateInputObjectSchema ]).optional(), _min: VoteMinAggregateInputObjectSchema.optional(), _max: VoteMaxAggregateInputObjectSchema.optional() })
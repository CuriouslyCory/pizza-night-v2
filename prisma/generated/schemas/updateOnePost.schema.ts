...
export const PostUpdateOneSchema = z.object({   data: z.union([PostUpdateInputObjectSchema, PostUncheckedUpdateInputObjectSchema]), where: PostWhereUniqueInputObjectSchema  })
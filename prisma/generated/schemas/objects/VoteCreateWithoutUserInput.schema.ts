...
const Schema = z.object({
  id: z.string().optional(),proposal: z.lazy(() => ProposalCreateNestedOneWithoutVotesInputObjectSchema),pizza: z.lazy(() => PizzaCreateNestedOneWithoutVoteInputObjectSchema).optional()
}).strict();

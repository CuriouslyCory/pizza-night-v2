...
const Schema = z.object({
  where: z.lazy(() => PizzaWhereUniqueInputObjectSchema),data: z.union([z.lazy(() => PizzaUpdateWithoutToppingsInputObjectSchema),
z.lazy(() => PizzaUncheckedUpdateWithoutToppingsInputObjectSchema)])
}).strict();

 export const PizzaUpdateWithWhereUniqueWithoutToppingsInputObjectSchema = Schema

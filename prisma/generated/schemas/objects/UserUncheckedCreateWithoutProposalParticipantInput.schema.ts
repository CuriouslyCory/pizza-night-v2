...
const Schema = z
  .object({
    ...
    posts: z
      .lazy(
        () => PostUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema,
      )
      .optional(),
    pizza: z
      .lazy(
        () => PizzaUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema,
      )
      .optional(),
    topping: z
      .lazy(
        () => ToppingUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema,
      )
      .optional(),
    vote: z
      .lazy(() => VoteUncheckedCreateNestedManyWithoutUserInputObjectSchema)
      .optional(),
    proposalCreator: z
      .lazy(
        () =>
          ProposalUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const UserUncheckedCreateWithoutProposalParticipantInputObjectSchema =
  Schema;

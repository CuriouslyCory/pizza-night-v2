...
z.lazy(() => ProposalCreateOrConnectWithoutParticipantsInputObjectSchema).array()]).optional(),upsert: z.union([z.lazy(() => ProposalUpsertWithWhereUniqueWithoutParticipantsInputObjectSchema),
z.lazy(() => ProposalUpsertWithWhereUniqueWithoutParticipantsInputObjectSchema).array()]).optional(),set: z.union([z.lazy(() => ProposalWhereUniqueInputObjectSchema),
...
z.lazy(() => ProposalWhereUniqueInputObjectSchema).array()]).optional(),update: z.union([z.lazy(() => ProposalUpdateWithWhereUniqueWithoutParticipantsInputObjectSchema),
z.lazy(() => ProposalUpdateWithWhereUniqueWithoutParticipantsInputObjectSchema).array()]).optional(),updateMany: z.union([z.lazy(() => ProposalUpdateManyWithWhereWithoutParticipantsInputObjectSchema),
z.lazy(() => ProposalUpdateManyWithWhereWithoutParticipantsInputObjectSchema).array()]).optional(),deleteMany: z.union([z.lazy(() => ProposalScalarWhereInputObjectSchema),
z.lazy(() => ProposalScalarWhereInputObjectSchema).array()]).optional()
}).strict();

 export const ProposalUncheckedUpdateManyWithoutParticipantsNestedInputObjectSchema = Schema

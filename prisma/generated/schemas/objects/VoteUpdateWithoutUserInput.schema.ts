...
const Schema = z.object({
  id: z.union([z.string(),
z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),proposal: z.lazy(() => ProposalUpdateOneRequiredWithoutVotesNestedInputObjectSchema).optional(),pizza: z.lazy(() => PizzaUpdateOneWithoutVoteNestedInputObjectSchema).optional()
}).strict();

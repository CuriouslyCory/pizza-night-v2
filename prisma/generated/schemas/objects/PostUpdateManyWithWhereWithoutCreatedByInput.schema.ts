...
const Schema = z.object({
  where: z.lazy(() => PostScalarWhereInputObjectSchema),data: z.union([z.lazy(() => PostUpdateManyMutationInputObjectSchema),
z.lazy(() => PostUncheckedUpdateManyWithoutPostsInputObjectSchema)])
}).strict();

 export const PostUpdateManyWithWhereWithoutCreatedByInputObjectSchema = Schema

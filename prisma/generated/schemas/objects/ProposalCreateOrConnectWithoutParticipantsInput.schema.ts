...
const Schema = z.object({
  where: z.lazy(() => ProposalWhereUniqueInputObjectSchema),create: z.union([z.lazy(() => ProposalCreateWithoutParticipantsInputObjectSchema),
z.lazy(() => ProposalUncheckedCreateWithoutParticipantsInputObjectSchema)])
}).strict();

 export const ProposalCreateOrConnectWithoutParticipantsInputObjectSchema = Schema

  ...
  .object({
    create: z
      .union([
        ...
        z
          .lazy(() => ProposalUncheckedCreateWithoutCreatedByInputObjectSchema)
          .array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => ProposalCreateOrConnectWithoutCreatedByInputObjectSchema),
        z
          .lazy(() => ProposalCreateOrConnectWithoutCreatedByInputObjectSchema)
          .array(),
      ])
      .optional(),
    upsert: z
      .union([
        z.lazy(
          () => ProposalUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema,
        ),
        z
          .lazy(
            () =>
      ...
      .optional(),
    createMany: z
      .lazy(() => ProposalCreateManyCreatedByInputEnvelopeObjectSchema)
      .optional(),
    set: z
      .union([
    ...
    update: z
      .union([
        z.lazy(
          () => ProposalUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema,
        ),
        z
          .lazy(
            () =>
    ...
    updateMany: z
      .union([
        z.lazy(
          () => ProposalUpdateManyWithWhereWithoutCreatedByInputObjectSchema,
        ),
        z
          .lazy(
            () => ProposalUpdateManyWithWhereWithoutCreatedByInputObjectSchema,
...
export const ProposalUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema;

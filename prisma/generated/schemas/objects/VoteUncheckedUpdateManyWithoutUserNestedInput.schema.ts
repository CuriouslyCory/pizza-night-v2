...
const Schema = z.object({
  create: z.union([z.lazy(() => VoteCreateWithoutUserInputObjectSchema),
z.lazy(() => VoteCreateWithoutUserInputObjectSchema).array(),
z.lazy(() => VoteUncheckedCreateWithoutUserInputObjectSchema),
z.lazy(() => VoteUncheckedCreateWithoutUserInputObjectSchema).array()]).optional(),connectOrCreate: z.union([z.lazy(() => VoteCreateOrConnectWithoutUserInputObjectSchema),
z.lazy(() => VoteCreateOrConnectWithoutUserInputObjectSchema).array()]).optional(),upsert: z.union([z.lazy(() => VoteUpsertWithWhereUniqueWithoutUserInputObjectSchema),
z.lazy(() => VoteUpsertWithWhereUniqueWithoutUserInputObjectSchema).array()]).optional(),createMany: z.lazy(() => VoteCreateManyUserInputEnvelopeObjectSchema).optional(),set: z.union([z.lazy(() => VoteWhereUniqueInputObjectSchema),
...
z.lazy(() => VoteWhereUniqueInputObjectSchema).array()]).optional(),update: z.union([z.lazy(() => VoteUpdateWithWhereUniqueWithoutUserInputObjectSchema),
z.lazy(() => VoteUpdateWithWhereUniqueWithoutUserInputObjectSchema).array()]).optional(),updateMany: z.union([z.lazy(() => VoteUpdateManyWithWhereWithoutUserInputObjectSchema),
z.lazy(() => VoteUpdateManyWithWhereWithoutUserInputObjectSchema).array()]).optional(),deleteMany: z.union([z.lazy(() => VoteScalarWhereInputObjectSchema),
z.lazy(() => VoteScalarWhereInputObjectSchema).array()]).optional()
}).strict();

 export const VoteUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema

...
const Schema = z
  .object({
    AND: z
      .union([
        z.lazy(() => ToppingScalarWhereWithAggregatesInputObjectSchema),
        z.lazy(() => ToppingScalarWhereWithAggregatesInputObjectSchema).array(),
      ])
      .optional(),
    OR: z
      .lazy(() => ToppingScalarWhereWithAggregatesInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([

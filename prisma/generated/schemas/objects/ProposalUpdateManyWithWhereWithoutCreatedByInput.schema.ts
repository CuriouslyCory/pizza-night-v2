...
z.lazy(() => ProposalUncheckedUpdateManyWithoutProposalCreatorInputObjectSchema)])
}).strict();

 export const ProposalUpdateManyWithWhereWithoutCreatedByInputObjectSchema = Schema

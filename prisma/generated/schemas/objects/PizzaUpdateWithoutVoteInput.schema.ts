...
z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),toppings: z.lazy(() => ToppingUpdateManyWithoutPizzaNestedInputObjectSchema).optional(),createdBy: z.lazy(() => UserUpdateOneRequiredWithoutPizzaNestedInputObjectSchema).optional()
}).strict();

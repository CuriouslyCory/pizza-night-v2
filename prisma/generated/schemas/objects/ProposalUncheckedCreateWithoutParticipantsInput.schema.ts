...
const Schema = z.object({
  id: z.string().optional(),createdBy: z.string(),createdAt: z.coerce.date().optional(),expiresAt: z.coerce.date(),votes: z.lazy(() => VoteUncheckedCreateNestedManyWithoutProposalInputObjectSchema).optional()
}).strict();

...
const Schema = z
  .object({
    ...
    posts: z
      .lazy(
        () => PostUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema,
      )
      .optional(),
    pizza: z
      .lazy(
        () => PizzaUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema,
      )
      .optional(),
    topping: z
      .lazy(
        () => ToppingUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema,
      )
      .optional(),
    vote: z
      .lazy(() => VoteUncheckedUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
    proposalCreator: z
      .lazy(
        () =>
          ProposalUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const UserUncheckedUpdateWithoutProposalParticipantInputObjectSchema =
  Schema;

...
z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),Pizza: z.lazy(() => PizzaUpdateManyWithoutToppingsNestedInputObjectSchema).optional()
}).strict();

 export const ToppingUpdateWithoutCreatedByInputObjectSchema = Schema

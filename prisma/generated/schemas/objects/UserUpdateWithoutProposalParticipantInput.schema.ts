...
const Schema = z
  .object({
    ...
    sessions: z
      ...
      .optional(),
    posts: z
      .lazy(() => PostUpdateManyWithoutCreatedByNestedInputObjectSchema)
      .optional(),
    pizza: z
      .lazy(() => PizzaUpdateManyWithoutCreatedByNestedInputObjectSchema)
      .optional(),
    topping: z
      .lazy(() => ToppingUpdateManyWithoutCreatedByNestedInputObjectSchema)
      .optional(),
    vote: z
      .lazy(() => VoteUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
    proposalCreator: z
      .lazy(() => ProposalUpdateManyWithoutCreatedByNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const UserUpdateWithoutProposalParticipantInputObjectSchema = Schema;

...
const Schema = z
  .object({
    create: z
      .union([
        z.lazy(() => UserCreateWithoutProposalCreatorInputObjectSchema),
        z.lazy(
          () => UserUncheckedCreateWithoutProposalCreatorInputObjectSchema,
        ),
      ])
      .optional(),
    connectOrCreate: z
      .lazy(() => UserCreateOrConnectWithoutProposalCreatorInputObjectSchema)
      .optional(),
    upsert: z
      .lazy(() => UserUpsertWithoutProposalCreatorInputObjectSchema)
      .optional(),
    connect: z.lazy(() => UserWhereUniqueInputObjectSchema).optional(),
    update: z
      .union([
        z.lazy(() => UserUpdateWithoutProposalCreatorInputObjectSchema),
        z.lazy(
          () => UserUncheckedUpdateWithoutProposalCreatorInputObjectSchema,
        ),
      ])
      .optional(),
  })
...
export const UserUpdateOneRequiredWithoutProposalCreatorNestedInputObjectSchema =
  Schema;

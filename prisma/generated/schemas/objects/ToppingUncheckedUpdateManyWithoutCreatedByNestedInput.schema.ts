...
const Schema = z
  .object({
    ...
    upsert: z
      .union([
        z.lazy(
          () => ToppingUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema,
        ),
        z
          .lazy(
            () => ToppingUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema,
    ...
    update: z
      .union([
        z.lazy(
          () => ToppingUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema,
        ),
        z
          .lazy(
            () => ToppingUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema,
    ...
    updateMany: z
      .union([
        z.lazy(
          () => ToppingUpdateManyWithWhereWithoutCreatedByInputObjectSchema,
        ),
        z
          .lazy(
            () => ToppingUpdateManyWithWhereWithoutCreatedByInputObjectSchema,
...
export const ToppingUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema;

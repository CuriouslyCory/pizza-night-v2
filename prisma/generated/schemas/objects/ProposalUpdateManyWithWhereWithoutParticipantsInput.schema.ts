...
const Schema = z.object({
  where: z.lazy(() => ProposalScalarWhereInputObjectSchema),data: z.union([z.lazy(() => ProposalUpdateManyMutationInputObjectSchema),
z.lazy(() => ProposalUncheckedUpdateManyWithoutProposalParticipantInputObjectSchema)])
}).strict();

 export const ProposalUpdateManyWithWhereWithoutParticipantsInputObjectSchema = Schema

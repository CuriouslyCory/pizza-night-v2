...
const Schema = z
  .object({
    create: z
      .union([
        z.lazy(() => VoteCreateWithoutPizzaInputObjectSchema),
        z.lazy(() => VoteCreateWithoutPizzaInputObjectSchema).array(),
        z.lazy(() => VoteUncheckedCreateWithoutPizzaInputObjectSchema),
        z.lazy(() => VoteUncheckedCreateWithoutPizzaInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => VoteCreateOrConnectWithoutPizzaInputObjectSchema),
        z.lazy(() => VoteCreateOrConnectWithoutPizzaInputObjectSchema).array(),
      ])
      .optional(),
    upsert: z
      .union([
        z.lazy(() => VoteUpsertWithWhereUniqueWithoutPizzaInputObjectSchema),
        z
          .lazy(() => VoteUpsertWithWhereUniqueWithoutPizzaInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
      .lazy(() => VoteCreateManyPizzaInputEnvelopeObjectSchema)
      .optional(),
    set: z
      .union([
    ...
    update: z
      .union([
        z.lazy(() => VoteUpdateWithWhereUniqueWithoutPizzaInputObjectSchema),
        z
          .lazy(() => VoteUpdateWithWhereUniqueWithoutPizzaInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
      .union([
        z.lazy(() => VoteUpdateManyWithWhereWithoutPizzaInputObjectSchema),
        z
          .lazy(() => VoteUpdateManyWithWhereWithoutPizzaInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const VoteUncheckedUpdateManyWithoutPizzaNestedInputObjectSchema =
  Schema;

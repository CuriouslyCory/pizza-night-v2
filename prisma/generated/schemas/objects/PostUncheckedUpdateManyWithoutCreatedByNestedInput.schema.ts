...
const Schema = z
  .object({
    ...
    upsert: z
      .union([
        z.lazy(
          () => PostUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema,
        ),
        z
          .lazy(
            () => PostUpsertWithWhereUniqueWithoutCreatedByInputObjectSchema,
    ...
    update: z
      .union([
        z.lazy(
          () => PostUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema,
        ),
        z
          .lazy(
            () => PostUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema,
    ...
    updateMany: z
      .union([
        z.lazy(() => PostUpdateManyWithWhereWithoutCreatedByInputObjectSchema),
        z
          .lazy(() => PostUpdateManyWithWhereWithoutCreatedByInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const PostUncheckedUpdateManyWithoutCreatedByNestedInputObjectSchema =
  Schema;

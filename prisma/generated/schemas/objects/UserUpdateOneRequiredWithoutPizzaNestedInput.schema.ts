...
z.lazy(() => UserUncheckedCreateWithoutPizzaInputObjectSchema)]).optional(),connectOrCreate: z.lazy(() => UserCreateOrConnectWithoutPizzaInputObjectSchema).optional(),upsert: z.lazy(() => UserUpsertWithoutPizzaInputObjectSchema).optional(),connect: z.lazy(() => UserWhereUniqueInputObjectSchema).optional(),update: z.union([z.lazy(() => UserUpdateWithoutPizzaInputObjectSchema),
z.lazy(() => UserUncheckedUpdateWithoutPizzaInputObjectSchema)]).optional()
}).strict();

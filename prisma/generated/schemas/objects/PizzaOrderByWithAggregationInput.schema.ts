...
const Schema = z
  .object({
    ...
    _count: z
      .lazy(() => PizzaCountOrderByAggregateInputObjectSchema)
      .optional(),
    _max: z.lazy(() => PizzaMaxOrderByAggregateInputObjectSchema).optional(),
    _min: z.lazy(() => PizzaMinOrderByAggregateInputObjectSchema).optional(),
  })
  .strict();

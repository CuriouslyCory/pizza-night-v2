  ...
  .object({
    create: z
      .union([
        ...
        z
          .lazy(() => VoteUncheckedCreateWithoutProposalInputObjectSchema)
          .array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => VoteCreateOrConnectWithoutProposalInputObjectSchema),
        z
          .lazy(() => VoteCreateOrConnectWithoutProposalInputObjectSchema)
          .array(),
      ])
      .optional(),
    upsert: z
      .union([
        z.lazy(() => VoteUpsertWithWhereUniqueWithoutProposalInputObjectSchema),
        z
          .lazy(() => VoteUpsertWithWhereUniqueWithoutProposalInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
      .lazy(() => VoteCreateManyProposalInputEnvelopeObjectSchema)
      .optional(),
    set: z
      .union([
    ...
    update: z
      .union([
        z.lazy(() => VoteUpdateWithWhereUniqueWithoutProposalInputObjectSchema),
        z
          .lazy(() => VoteUpdateWithWhereUniqueWithoutProposalInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
      .union([
        z.lazy(() => VoteUpdateManyWithWhereWithoutProposalInputObjectSchema),
        z
          .lazy(() => VoteUpdateManyWithWhereWithoutProposalInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const VoteUncheckedUpdateManyWithoutProposalNestedInputObjectSchema =
  Schema;

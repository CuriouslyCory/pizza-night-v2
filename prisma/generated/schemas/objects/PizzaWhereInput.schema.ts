...
const Schema = z
  .object({
    AND: z
      .union([
        z.lazy(() => PizzaWhereInputObjectSchema),
        z.lazy(() => PizzaWhereInputObjectSchema).array(),
      ])
      .optional(),
    OR: z
      .lazy(() => PizzaWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
    ...
    updatedAt: z
      .union([z.lazy(() => DateTimeFilterObjectSchema), z.coerce.date()])
      .optional(),
    toppings: z.lazy(() => ToppingListRelationFilterObjectSchema).optional(),
    createdBy: z
      .union([

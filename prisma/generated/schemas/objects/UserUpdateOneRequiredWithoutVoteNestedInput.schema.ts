...
const Schema = z.object({
  create: z.union([z.lazy(() => UserCreateWithoutVoteInputObjectSchema),
z.lazy(() => UserUncheckedCreateWithoutVoteInputObjectSchema)]).optional(),connectOrCreate: z.lazy(() => UserCreateOrConnectWithoutVoteInputObjectSchema).optional(),upsert: z.lazy(() => UserUpsertWithoutVoteInputObjectSchema).optional(),connect: z.lazy(() => UserWhereUniqueInputObjectSchema).optional(),update: z.union([z.lazy(() => UserUpdateWithoutVoteInputObjectSchema),
z.lazy(() => UserUncheckedUpdateWithoutVoteInputObjectSchema)]).optional()
}).strict();

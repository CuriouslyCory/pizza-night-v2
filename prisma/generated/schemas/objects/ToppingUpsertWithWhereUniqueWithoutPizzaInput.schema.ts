...
const Schema = z.object({
  where: z.lazy(() => ToppingWhereUniqueInputObjectSchema),update: z.union([z.lazy(() => ToppingUpdateWithoutPizzaInputObjectSchema),
z.lazy(() => ToppingUncheckedUpdateWithoutPizzaInputObjectSchema)]),create: z.union([z.lazy(() => ToppingCreateWithoutPizzaInputObjectSchema),

...
z.lazy(() => PizzaCreateOrConnectWithoutCreatedByInputObjectSchema).array()]).optional(),createMany: z.lazy(() => PizzaCreateManyCreatedByInputEnvelopeObjectSchema).optional(),connect: z.union([z.lazy(() => PizzaWhereUniqueInputObjectSchema),
z.lazy(() => PizzaWhereUniqueInputObjectSchema).array()]).optional()
}).strict();

 export const PizzaUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema = Schema

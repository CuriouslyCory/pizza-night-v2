...
const Schema = z
  .object({
    AND: z
      .union([
        z.lazy(() => ToppingWhereInputObjectSchema),
        z.lazy(() => ToppingWhereInputObjectSchema).array(),
      ])
      .optional(),
    OR: z
      .lazy(() => ToppingWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
    ...
    createdBy: z
      ...
      .optional(),
    Pizza: z.lazy(() => PizzaListRelationFilterObjectSchema).optional(),
  })
  .strict();

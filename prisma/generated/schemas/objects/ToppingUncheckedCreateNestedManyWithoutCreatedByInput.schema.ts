...
z.lazy(() => ToppingCreateOrConnectWithoutCreatedByInputObjectSchema).array()]).optional(),createMany: z.lazy(() => ToppingCreateManyCreatedByInputEnvelopeObjectSchema).optional(),connect: z.union([z.lazy(() => ToppingWhereUniqueInputObjectSchema),
z.lazy(() => ToppingWhereUniqueInputObjectSchema).array()]).optional()
}).strict();

 export const ToppingUncheckedCreateNestedManyWithoutCreatedByInputObjectSchema = Schema

...
const Schema = z
  .object({
    ...
    _count: z
      .lazy(() => ProposalCountOrderByAggregateInputObjectSchema)
      .optional(),
    _max: z.lazy(() => ProposalMaxOrderByAggregateInputObjectSchema).optional(),
    _min: z.lazy(() => ProposalMinOrderByAggregateInputObjectSchema).optional(),
  })
  .strict();

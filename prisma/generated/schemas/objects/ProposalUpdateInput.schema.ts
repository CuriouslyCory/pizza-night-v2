...
z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),creator: z.lazy(() => UserUpdateOneRequiredWithoutProposalCreatorNestedInputObjectSchema).optional(),votes: z.lazy(() => VoteUpdateManyWithoutProposalNestedInputObjectSchema).optional(),participants: z.lazy(() => UserUpdateManyWithoutProposalParticipantNestedInputObjectSchema).optional()
}).strict();

 export const ProposalUpdateInputObjectSchema = Schema

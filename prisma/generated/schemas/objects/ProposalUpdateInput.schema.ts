...
const Schema = z
  .object({
    ...
    createdBy: z
      .lazy(
        () =>
          UserUpdateOneRequiredWithoutProposalCreatorNestedInputObjectSchema,
      )
      .optional(),
    votes: z
      .lazy(() => VoteUpdateManyWithoutProposalNestedInputObjectSchema)
      .optional(),
    participants: z
      .lazy(
        () => UserUpdateManyWithoutProposalParticipantNestedInputObjectSchema,
      )
      .optional(),
  })
  .strict();

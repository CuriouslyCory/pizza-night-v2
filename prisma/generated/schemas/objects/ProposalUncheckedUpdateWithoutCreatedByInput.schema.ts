...
z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),votes: z.lazy(() => VoteUncheckedUpdateManyWithoutProposalNestedInputObjectSchema).optional(),participants: z.lazy(() => UserUncheckedUpdateManyWithoutProposalParticipantNestedInputObjectSchema).optional()
}).strict();

 export const ProposalUncheckedUpdateWithoutCreatedByInputObjectSchema = Schema

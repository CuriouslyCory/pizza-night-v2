...
const Schema = z.object({
  where: z.lazy(() => PizzaWhereUniqueInputObjectSchema),update: z.union([z.lazy(() => PizzaUpdateWithoutToppingsInputObjectSchema),
z.lazy(() => PizzaUncheckedUpdateWithoutToppingsInputObjectSchema)]),create: z.union([z.lazy(() => PizzaCreateWithoutToppingsInputObjectSchema),
z.lazy(() => PizzaUncheckedCreateWithoutToppingsInputObjectSchema)])
}).strict();

 export const PizzaUpsertWithWhereUniqueWithoutToppingsInputObjectSchema = Schema

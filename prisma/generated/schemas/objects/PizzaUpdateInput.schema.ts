...
z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),toppings: z.lazy(() => ToppingUpdateManyWithoutPizzaNestedInputObjectSchema).optional(),createdBy: z.lazy(() => UserUpdateOneRequiredWithoutPizzaNestedInputObjectSchema).optional(),Vote: z.lazy(() => VoteUpdateManyWithoutPizzaNestedInputObjectSchema).optional()
}).strict();

 export const PizzaUpdateInputObjectSchema = Schema

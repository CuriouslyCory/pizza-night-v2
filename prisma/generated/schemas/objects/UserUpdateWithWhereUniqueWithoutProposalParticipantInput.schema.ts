...
const Schema = z
  .object({
    ...
    data: z.union([
      z.lazy(() => UserUpdateWithoutProposalParticipantInputObjectSchema),
      z.lazy(
        () => UserUncheckedUpdateWithoutProposalParticipantInputObjectSchema,
      ),
    ]),
  })
  .strict();

export const UserUpdateWithWhereUniqueWithoutProposalParticipantInputObjectSchema =
  Schema;

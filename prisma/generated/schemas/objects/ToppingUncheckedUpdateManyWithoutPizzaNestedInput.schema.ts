...
z.lazy(() => ToppingCreateOrConnectWithoutPizzaInputObjectSchema).array()]).optional(),upsert: z.union([z.lazy(() => ToppingUpsertWithWhereUniqueWithoutPizzaInputObjectSchema),
z.lazy(() => ToppingUpsertWithWhereUniqueWithoutPizzaInputObjectSchema).array()]).optional(),set: z.union([z.lazy(() => ToppingWhereUniqueInputObjectSchema),
...
z.lazy(() => ToppingWhereUniqueInputObjectSchema).array()]).optional(),update: z.union([z.lazy(() => ToppingUpdateWithWhereUniqueWithoutPizzaInputObjectSchema),
z.lazy(() => ToppingUpdateWithWhereUniqueWithoutPizzaInputObjectSchema).array()]).optional(),updateMany: z.union([z.lazy(() => ToppingUpdateManyWithWhereWithoutPizzaInputObjectSchema),
z.lazy(() => ToppingUpdateManyWithWhereWithoutPizzaInputObjectSchema).array()]).optional(),deleteMany: z.union([z.lazy(() => ToppingScalarWhereInputObjectSchema),
z.lazy(() => ToppingScalarWhereInputObjectSchema).array()]).optional()
}).strict();

 export const ToppingUncheckedUpdateManyWithoutPizzaNestedInputObjectSchema = Schema

...
const Schema = z.object({
  where: z.lazy(() => ProposalWhereUniqueInputObjectSchema),data: z.union([z.lazy(() => ProposalUpdateWithoutCreatedByInputObjectSchema),
z.lazy(() => ProposalUncheckedUpdateWithoutCreatedByInputObjectSchema)])
}).strict();

 export const ProposalUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema = Schema

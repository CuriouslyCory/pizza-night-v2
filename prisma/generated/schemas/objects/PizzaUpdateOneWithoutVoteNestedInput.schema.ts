...
z.lazy(() => PizzaUncheckedCreateWithoutVoteInputObjectSchema)]).optional(),connectOrCreate: z.lazy(() => PizzaCreateOrConnectWithoutVoteInputObjectSchema).optional(),upsert: z.lazy(() => PizzaUpsertWithoutVoteInputObjectSchema).optional(),disconnect: z.boolean().optional(),delete: z.boolean().optional(),connect: z.lazy(() => PizzaWhereUniqueInputObjectSchema).optional(),update: z.union([z.lazy(() => PizzaUpdateWithoutVoteInputObjectSchema),
z.lazy(() => PizzaUncheckedUpdateWithoutVoteInputObjectSchema)]).optional()
}).strict();

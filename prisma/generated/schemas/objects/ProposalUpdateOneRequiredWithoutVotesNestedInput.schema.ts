...
const Schema = z
  .object({
    create: z
      ...
      .optional(),
    connectOrCreate: z
      .lazy(() => ProposalCreateOrConnectWithoutVotesInputObjectSchema)
      .optional(),
    upsert: z
      .lazy(() => ProposalUpsertWithoutVotesInputObjectSchema)
      .optional(),
    connect: z.lazy(() => ProposalWhereUniqueInputObjectSchema).optional(),
    update: z
      .union([
        z.lazy(() => ProposalUpdateWithoutVotesInputObjectSchema),
        z.lazy(() => ProposalUncheckedUpdateWithoutVotesInputObjectSchema),
      ])
      .optional(),
  })
  .strict();

export const ProposalUpdateOneRequiredWithoutVotesNestedInputObjectSchema =
  Schema;

...
const Schema = z.object({
  where: z.lazy(() => PostWhereUniqueInputObjectSchema),data: z.union([z.lazy(() => PostUpdateWithoutCreatedByInputObjectSchema),
z.lazy(() => PostUncheckedUpdateWithoutCreatedByInputObjectSchema)])
}).strict();

 export const PostUpdateWithWhereUniqueWithoutCreatedByInputObjectSchema = Schema

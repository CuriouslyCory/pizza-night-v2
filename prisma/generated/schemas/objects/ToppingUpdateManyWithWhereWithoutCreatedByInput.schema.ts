...
const Schema = z
  .object({
    where: z.lazy(() => ToppingScalarWhereInputObjectSchema),
    data: z.union([
      z.lazy(() => ToppingUpdateManyMutationInputObjectSchema),
      z.lazy(() => ToppingUncheckedUpdateManyWithoutToppingInputObjectSchema),
    ]),
  })
  .strict();

export const ToppingUpdateManyWithWhereWithoutCreatedByInputObjectSchema =
  Schema;

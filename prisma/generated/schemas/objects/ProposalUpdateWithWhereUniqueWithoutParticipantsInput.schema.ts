...
const Schema = z.object({
  where: z.lazy(() => ProposalWhereUniqueInputObjectSchema),data: z.union([z.lazy(() => ProposalUpdateWithoutParticipantsInputObjectSchema),
z.lazy(() => ProposalUncheckedUpdateWithoutParticipantsInputObjectSchema)])
}).strict();

 export const ProposalUpdateWithWhereUniqueWithoutParticipantsInputObjectSchema = Schema

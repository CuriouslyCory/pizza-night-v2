...
z.lazy(() => VoteCreateOrConnectWithoutUserInputObjectSchema).array()]).optional(),createMany: z.lazy(() => VoteCreateManyUserInputEnvelopeObjectSchema).optional(),connect: z.union([z.lazy(() => VoteWhereUniqueInputObjectSchema),
z.lazy(() => VoteWhereUniqueInputObjectSchema).array()]).optional()
}).strict();

 export const VoteUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema

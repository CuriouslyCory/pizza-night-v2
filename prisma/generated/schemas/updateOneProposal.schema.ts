...
export const ProposalUpdateOneSchema = z.object({   data: z.union([ProposalUpdateInputObjectSchema, ProposalUncheckedUpdateInputObjectSchema]), where: ProposalWhereUniqueInputObjectSchema  })
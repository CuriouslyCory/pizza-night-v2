...
export const ToppingAggregateSchema = z.object({ orderBy: z.union([ToppingOrderByWithRelationInputObjectSchema, ToppingOrderByWithRelationInputObjectSchema.array()]).optional(), where: ToppingWhereInputObjectSchema.optional(), cursor: ToppingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), _count: z.union([ z.literal(true), ToppingCountAggregateInputObjectSchema ]).optional(), _min: ToppingMinAggregateInputObjectSchema.optional(), _max: ToppingMaxAggregateInputObjectSchema.optional() })
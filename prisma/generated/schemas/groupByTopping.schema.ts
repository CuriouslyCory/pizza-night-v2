...
export const ToppingGroupBySchema = z.object({ where: ToppingWhereInputObjectSchema.optional(), orderBy: z.union([ToppingOrderByWithAggregationInputObjectSchema, ToppingOrderByWithAggregationInputObjectSchema.array()]).optional(), having: ToppingScalarWhereWithAggregatesInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), by: z.array(ToppingScalarFieldEnumSchema)  })
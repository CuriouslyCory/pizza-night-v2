...
export const PostUpsertSchema = z.object({   where: PostWhereUniqueInputObjectSchema, create: z.union([ PostCreateInputObjectSchema, PostUncheckedCreateInputObjectSchema ]), update: z.union([ PostUpdateInputObjectSchema, PostUncheckedUpdateInputObjectSchema ])  })
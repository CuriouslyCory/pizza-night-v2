...
export const VoteUpdateOneSchema = z.object({   data: z.union([VoteUpdateInputObjectSchema, VoteUncheckedUpdateInputObjectSchema]), where: VoteWhereUniqueInputObjectSchema  })
...
export const ProposalGroupBySchema = z.object({ where: ProposalWhereInputObjectSchema.optional(), orderBy: z.union([ProposalOrderByWithAggregationInputObjectSchema, ProposalOrderByWithAggregationInputObjectSchema.array()]).optional(), having: ProposalScalarWhereWithAggregatesInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), by: z.array(ProposalScalarFieldEnumSchema)  })
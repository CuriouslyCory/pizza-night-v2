...
export const PizzaGroupBySchema = z.object({
  where: PizzaWhereInputObjectSchema.optional(),
  orderBy: z
    .union([
      PizzaOrderByWithAggregationInputObjectSchema,
      PizzaOrderByWithAggregationInputObjectSchema.array(),
    ])
    .optional(),
  having: PizzaScalarWhereWithAggregatesInputObjectSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  by: z.array(PizzaScalarFieldEnumSchema),
});

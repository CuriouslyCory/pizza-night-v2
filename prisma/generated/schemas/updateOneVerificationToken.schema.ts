...
export const VerificationTokenUpdateOneSchema = z.object({   data: z.union([VerificationTokenUpdateInputObjectSchema, VerificationTokenUncheckedUpdateInputObjectSchema]), where: VerificationTokenWhereUniqueInputObjectSchema  })
...
export const VoteUpsertSchema = z.object({   where: VoteWhereUniqueInputObjectSchema, create: z.union([ VoteCreateInputObjectSchema, VoteUncheckedCreateInputObjectSchema ]), update: z.union([ VoteUpdateInputObjectSchema, VoteUncheckedUpdateInputObjectSchema ])  })
...
export const ProposalAggregateSchema = z.object({
  orderBy: z
    .union([
      ProposalOrderByWithRelationInputObjectSchema,
      ProposalOrderByWithRelationInputObjectSchema.array(),
    ])
    .optional(),
  where: ProposalWhereInputObjectSchema.optional(),
  cursor: ProposalWhereUniqueInputObjectSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  _count: z
    .union([z.literal(true), ProposalCountAggregateInputObjectSchema])
    .optional(),
  _min: ProposalMinAggregateInputObjectSchema.optional(),
  _max: ProposalMaxAggregateInputObjectSchema.optional(),
});

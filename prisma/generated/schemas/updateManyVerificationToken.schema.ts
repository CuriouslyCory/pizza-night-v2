...
export const VerificationTokenUpdateManySchema = z.object({ data: VerificationTokenUpdateManyMutationInputObjectSchema, where: VerificationTokenWhereInputObjectSchema.optional()  })
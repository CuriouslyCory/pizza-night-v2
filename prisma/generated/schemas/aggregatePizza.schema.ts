...
export const PizzaAggregateSchema = z.object({
  orderBy: z
    .union([
      PizzaOrderByWithRelationInputObjectSchema,
      PizzaOrderByWithRelationInputObjectSchema.array(),
    ])
    .optional(),
  where: PizzaWhereInputObjectSchema.optional(),
  cursor: PizzaWhereUniqueInputObjectSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  _count: z
    .union([z.literal(true), PizzaCountAggregateInputObjectSchema])
    .optional(),
  _min: PizzaMinAggregateInputObjectSchema.optional(),
  _max: PizzaMaxAggregateInputObjectSchema.optional(),
});

...
export const ProposalUpsertSchema = z.object({   where: ProposalWhereUniqueInputObjectSchema, create: z.union([ ProposalCreateInputObjectSchema, ProposalUncheckedCreateInputObjectSchema ]), update: z.union([ ProposalUpdateInputObjectSchema, ProposalUncheckedUpdateInputObjectSchema ])  })
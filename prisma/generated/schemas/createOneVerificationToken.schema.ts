...
export const VerificationTokenCreateOneSchema = z.object({   data: z.union([VerificationTokenCreateInputObjectSchema, VerificationTokenUncheckedCreateInputObjectSchema])  })
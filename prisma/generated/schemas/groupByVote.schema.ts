...
export const VoteGroupBySchema = z.object({ where: VoteWhereInputObjectSchema.optional(), orderBy: z.union([VoteOrderByWithAggregationInputObjectSchema, VoteOrderByWithAggregationInputObjectSchema.array()]).optional(), having: VoteScalarWhereWithAggregatesInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), by: z.array(VoteScalarFieldEnumSchema)  })